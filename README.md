...
2. Add your template content with optional variables like `{{date}}` and `{{title}}`.
...
5. **Add file-specific settings**: Create new `autocmd` groups in the "Auto commands" section for different file types.
